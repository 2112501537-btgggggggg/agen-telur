...
const membershipPublicRoutes = require('./routes/membershipPublic.routes');
const priceRoutes = require('./routes/price.routes');
const supplierRoutes = require('./routes/supplier.routes');
const stockInRoutes = require('./routes/stockIn.routes');
const { customerRouter: orderCustomerRoutes, adminRouter: orderAdminRoutes } = require('./routes/order.routes');
...
app.use('/api/membership-info', membershipPublicRoutes);
