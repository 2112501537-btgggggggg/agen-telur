...
export default function DeleteCategoryDialog({ open, onOpenChange, category, onConfirm }) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-3">
          <p className="text-sm text-muted-foreground">
            Yakin ingin menghapus kategori <span className="font-semibold text-foreground">&apos;{category?.name}&apos;</span>?
          </p>
