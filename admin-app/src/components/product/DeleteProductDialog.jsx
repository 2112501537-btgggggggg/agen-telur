...
export default function DeleteProductDialog({ open, onOpenChange, product, onConfirm }) {
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-3">
          <p className="text-sm text-muted-foreground">
            Yakin ingin menghapus produk <span className="font-semibold text-foreground">&apos;{product?.name}&apos;</span>?
          </p>
          <p className="text-xs text-neutral-gray">
            Produk akan ditandai sebagai nonaktif. Tindakan ini tidak bisa dibatalkan.
          </p>
          {errorMsg && (
        ...
        <div className="flex justify-end gap-2 mt-2">
          <Button variant="outline" onClick={handleClose} disabled={isDeleting}>Batal</Button>
          <Button
            variant="destructive"
